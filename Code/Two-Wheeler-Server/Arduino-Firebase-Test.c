...
void readAndSendSensorData() {
  ...
  JSONVar sensorData;
  sensorData["temp"]=tempV;
  sensorData["current"]=current1;
  sensorData["orientation_x"]=orientation_x;
  sensorData["orientation_y"]=orientation_y;
  sensorData["orientation_z"]=orientation_z;
  sensorData["acceleration_x"]=acceleration_x;
  sensorData["acceleration_y"]=acceleration_y;
  sensorData["acceleration_z"]=acceleration_z;
  sensorData["magnetometer_x"]=magnetometer_x;
  sensorData["magnetometer_y"]=magnetometer_y;
  sensorData["magnetometer_z"]=magnetometer_z;
  sensorData["gyroscope_x"]=gyroscope_x;
  sensorData["gyroscope_y"]=gyroscope_y;
  sensorData["gyroscope_z"]=gyroscope_z;
  sensorData["orientation_x"]=orientation_x;
  sensorData["orientation_y"]=orientation_y;
  sensorData["orientation_z"]=orientation_z;
  sensorData["gravity_x"]=gravity_x;
  sensorData["gravity_y"]=gravity_y;
  sensorData["gravity_z"]=gravity_z;
  // Send LM35 and Current sensor data to Firebase
  // counter++;
  String initial = "SensorDataOneDecember/"+String(millis());
  Firebase.pushJSON(fbdo, initial, sensorData);
}